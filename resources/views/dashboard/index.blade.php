                  ...
                  <div class="col-6 p-0 m-0">
                    <div class="card-body p-24 h-100 d-flex flex-column justify-content-center border border-top-0">
                      ...
                      <p class="text-sm mb-0">Increase by <span
                          class="bg-success-focus px-1 rounded-2 fw-medium text-success-main text-sm">+200</span> this
                        week</p>
                    </div>
                  </div>
                  <div class="col-6 p-0 m-0">
                    <div
                      ...
                      <p class="text-sm mb-0">Increase by <span
                          class="bg-danger-focus px-1 rounded-2 fw-medium text-danger-main text-sm">-5k</span> this week
                      </p>
                    </div>
                  </div>
                  <div class="col-6 p-0 m-0">
                    <div
                      ...
                      <p class="text-sm mb-0">Increase by <span
                          class="bg-success-focus px-1 rounded-2 fw-medium text-success-main text-sm">+1k</span> this
                        week</p>
                    </div>
                  </div>
                  <div class="col-6 p-0 m-0">
                    <div
                      ...
                      <p class="text-sm mb-0">Increase by <span
                          class="bg-success-focus px-1 rounded-2 fw-medium text-success-main text-sm">+$10k</span> this
                        week</p>
                    </div>
                  </div>
                </div>
                ...
                <table class="table bordered-table mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="images/users/user1.png" alt="" class="flex-shrink-0 me-12 radius-8">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="images/users/user2.png" alt="" class="flex-shrink-0 me-12 radius-8">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="images/users/user3.png" alt="" class="flex-shrink-0 me-12 radius-8">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="images/users/user4.png" alt="" class="flex-shrink-0 me-12 radius-8">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="images/users/user5.png" alt="" class="flex-shrink-0 me-12 radius-8">
              ...
              <div class="mt-32">
                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                  <div class="d-flex align-items-center gap-2">
                    <img src="images/payment/payment1.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                ...
                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                  <div class="d-flex align-items-center gap-2">
                    <img src="images/payment/payment2.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                    <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                  <div class="d-flex align-items-center gap-2">
                    <img src="images/payment/payment3.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                    <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                  <div class="d-flex align-items-center gap-2">
                    <img src="images/payment/payment4.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                    <div class="flex-grow-1">
          ...
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <div class="mt-32">
                ...
                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                  <div class="d-flex align-items-center gap-2">
                    <img src="images/users/user6.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                    <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                  <div class="d-flex align-items-center gap-2">
                    <img src="images/users/user1.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                    <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                  <div class="d-flex align-items-center gap-2">
                    <img src="images/users/user2.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                    <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                  <div class="d-flex align-items-center gap-2">
                    <img src="images/users/user3.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                    <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                  <div class="d-flex align-items-center gap-2">
                    <img src="images/users/user4.png" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                    <div class="flex-grow-1">
                ...
                <table class="table bordered-table mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="images/product/product-img1.png" alt=""
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="images/product/product-img2.png" alt=""
                            class="flex-shrink-0 me-12 radius-8 me-12">
                          <div class="flex-grow-1">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="images/product/product-img3.png" alt=""
                            class="flex-shrink-0 me-12 radius-8 me-12">
                          <div class="flex-grow-1">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="images/product/product-img4.png" alt=""
                            class="flex-shrink-0 me-12 radius-8 me-12">
                          <div class="flex-grow-1">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="images/product/product-img5.png" alt=""
                            class="flex-shrink-0 me-12 radius-8 me-12">
                          <div class="flex-grow-1">
